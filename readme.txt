...
## Shortcodes
* Default Shortcode
<pre>[spwrk_post_grid]</pre>

* Control for Show or Hide the filter
Options: yes,no
Default: yes
<pre>[spwrk_post_grid show_filter="no"]</pre>

* Control Number of Posts Per Page
Options: Integers, -1 for all posts
Default: WordPress Default
<pre>[spwrk_post_grid posts_per_page="6"]</pre>

* Post pagination
Options: yes,no
Default: "yes"
<pre>[spwrk_post_grid posts_per_page="6" paginate="yes"]</pre>

* Show/Hide "All" Button before filter
Options: yes,no
Default: "yes"
<pre>[spwrk_post_grid btn_all="yes"]</pre>

* Show/Hide Specific Category Terms
Options: 1,2,3,4
Default: ""
<pre>[spwrk_post_grid cat="100,101,103"]</pre>
or
<pre>[spwrk_post_grid terms="100,101,103"]</pre>

* Hide/Show Empty Category Terms
Options: true, false
Default: "true"
<pre>[spwrk_post_grid hide_empty="false"]</pre>

* Post Order
Options: ASC, DESC
Default: "DESC"
<pre>[spwrk_post_grid order="DESC"]</pre>

* Post Orderby
Default: 'menu_order date', //Display posts sorted by ‘menu_order’ with a fallback to post ‘date’
<pre>[spwrk_post_grid orderby="title"]</pre>
...
Options: "",load_more
Default: ""
<pre>[spwrk_post_grid pagination_type="load_more"]</pre>


* Infinite Scroll (Works only for pagination_type="load_more" attributes )
Options: "",true
Default: ""
<pre>[spwrk_post_grid infinite_scroll="true"]</pre>


* Animation effect
Options: "",true
Default: ""
<pre>[spwrk_post_grid animation="true"]</pre>
...
= How to use it? =
use this shortcode: [spwrk_post_grid]
